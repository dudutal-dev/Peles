  ...
  return (
    <div className="screen">
      ...
      <p className="screen-sub" style={{ marginBlock: '28px 8px', textAlign: 'center' }}>
        פלס, גרסה {__APP_VERSION__}. הנתונים נשמרים במכשיר הזה בלבד.
      </p>
    </div>
  );
}
          ...
          <div className="settings-text">
            ...
            <p>
              {storage?.persisted
                ...
                : 'במחסור במקום הדפדפן עלול למחוק נתונים. התקנה למסך הבית ואחסון קבוע מפחיתים את הסיכון.'}
              {storage?.usageMB != null && ` בשימוש: ${storage.usageMB.toFixed(1)}MB.`}
            </p>
          </div>
